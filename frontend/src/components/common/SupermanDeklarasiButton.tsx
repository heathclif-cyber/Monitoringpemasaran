  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description={`Draft masuk To Do List Superman untuk DO ${noDo}. Syarat sama semua komoditi: upload salah satu dokumen pendukung (kontrak, BA, deklarasi, atau DO/SPPB). Jika kontrak kena PPh, sistem otomatis membuat SPPb + SPPn.`}
